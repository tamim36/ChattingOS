...
public class ChattingOS extends javax.swing.JFrame implements writableGUI {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChattingOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChattingOS().setVisible(true);
            }
        });
    }
